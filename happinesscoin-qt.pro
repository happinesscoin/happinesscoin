TEMPLATE = app
TARGET = happinesscoin-qt
macx:TARGET = "-I/root/HappinessCoin/src/leveldb/helpers-Qt"
VERSION = 0.8.7.4
...
macx:ICON = src/qt/res/icons/happinesscoin.icns
